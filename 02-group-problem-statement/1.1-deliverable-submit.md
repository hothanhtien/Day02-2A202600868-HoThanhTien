...
Case ví dụ: **Hỗ trợ sinh viên tìm thông tin, setup môi trường và gửi câu hỏi đủ context**
...
→ [3 Mở PDF/Slide: 3']
→ [4 Mở GitHub/LMS: 3']
→ [5 So sánh nhiều nguồn: 4']  <-- bottleneck
→ [6 Hỏi TA: 1']
```
...
[1 Student Question: 30s]
→ [2 AI Retrieve Sources: 30s]
→ [3 AI Generate Answer: 30s]
→ [4 Show References: 15s]
→ [5 Student Verify: 15s]

Fallback: Không đủ dữ liệu → Escalate TA
```
...
[1 Upload Log: 1']
→ [2 AI Detect Environment: 2']
→ [3 AI Classify Error: 1']
→ [4 AI Suggest Fix: 5']
→ [5 Retry: 5']
→ [6 Escalate TA: 1']
...
[1 Student Ask: 1']
→ [2 AI Check Context: 1']
→ [3 Missing Info Request: 2']
→ [4 Auto Classification: 1']
→ [5 Forward To TA: 1']
→ [6 Support: 2']
